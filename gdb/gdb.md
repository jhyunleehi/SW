...
$ gdbserver 127.0.0.1:8844 main
Process /root/main created; pid = 451923
...
```
root@c1:~# gdb ./main
(gdb) target remote localhost:8844
(gdb) b main
Breakpoint 1 at 0x555555555209: file main.c, line 4.
(gdb) l
1       #include <stdio.h>
2
3       char str[10]="hello";
...
```
# ps -ef | grep main
root      452809    5870  9 13:55 pts/3    00:00:00 ./main
root      452812    5427  0 13:55 pts/0    00:00:00 grep --color=auto main

# gdbserver --attach :1234 452809
Attached; pid = 452809
...
(gdb) p str
$1 = "hello\000\000\000\000"
(gdb) p *str
$2 = 104 'h'
(gdb) x/s str
0x563e6b2e6010 <str>:   "hello"
(gdb) x/s 0x563e6b2e6010
0x563e6b2e6010 <str>:   "hello"
